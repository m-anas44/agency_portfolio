...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Absolutely! You can upgrade at any time, and we’ll ensure a smooth transition.',
  },
  {
    question: 'What platforms do you support for E-commerce?',
    answer: 'We specialize in Shopify, WooCommerce, and custom-built platforms tailored to your needs.',
  },
];
  ...
  return (
    <section>
      <div className='max-w-6xl px-4 py-20 mx-auto sm:px-6 lg:px-8'>
        <h2 className='mb-10 text-3xl font-extrabold text-center text-secondary'>Frequently Asked Questions</h2>
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <div className='p-6 cursor-pointer group'>
                ...
                <p className='hidden mt-4 text-gray-600 group-hover:block'>{faq.answer}</p>
              </div>
            </div>
          ))}
        </div>
