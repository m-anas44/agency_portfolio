    ...
    <section className='px-3 sm:px-4 md:px-6 lg:px-20 py-10 bg-gradient-to-t from-teal-300 via-teal-50 to-white'>
      <div className='grid gap-10 lg:grid-cols-2'>
        ...
        <article>
          ...
          <div className='flex flex-wrap items-center justify-center gap-6 mt-8 sm:gap-x-12 text-secondary md:justify-start lg:justify-start md:px-10 lg:px-0'>
        ...
        <article className='p-4 bg-white rounded-lg shadow-xl sm:p-8'>
          <div className='flex flex-col items-start justify-between xs:flex-row'>
            <div className='flex flex-col items-start gap-2'>
              <h3 className='text-lg font-semibold sm:text-xl text-secondary/90'>{plan?.planName}</h3>
              <h2 className='flex items-end justify-between text-4xl font-bold sm:text-5xl text-secondary/90'>
                ${plan?.price}
              </h2>
              <span className='px-2 py-1 text-xs text-white rounded bg-secondary sm:text-sm'>{plan?.category}</span>
            </div>
