      ...
      <div className='container grid grid-cols-1 gap-12 mx-auto lg:grid-cols-2'>
        ...
        <div>
          ...
          <div className='flex gap-4 mt-8'>
            <Button
              className='text-lg text-white transition rounded-md xs:text-xl bg-primary hover:bg-secondary hover:text-primary'
              onClick={() => {
                navigate('/aboutUs');
                window.scrollTo(0, 0);
              }}
            ...
            <Button
              className='text-base transition-all bg-transparent border rounded-md xs:text-xl border-primary text-primary hover:bg-secondary hover:text-tertiary'
              onClick={() => {
                navigate('/services');
                window.scrollTo(0, 0);
              }}
