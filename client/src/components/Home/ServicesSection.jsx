        ...
        <header className='flex flex-col items-center justify-between mb-10 md:flex-row'>
          ...
          <div>
            <Button
              ...
              aria-label='View All Services' // Added aria-label for accessibility
            >
              All Services
            </Button>
          </div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <Link to={'/service-detail'}>
                <button
                  className='relative z-10 flex items-center gap-1 p-2 border rounded-full drop-shadow-xl group-hover:primary/70 border-secondary group-hover:bg-white'
                  aria-label={`Read more about ${service.title}`} // Added dynamic aria-label for accessibility
                >
