          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="relative flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                <button
                  className="flex items-center px-4 py-2 lg:px-5 lg:py-3 text-nowrap overflow-hidden text-base font-medium rounded-full sm:text-lg text-tertiary bg-primary hover:bg-tertiary hover:text-primary group"
              ...
              <div className="block md:hidden">
                <button
                  onClick={toggleMenu}
                  className="p-2 transition rounded text-primary bg-tertiary"
                >
                  <svg
